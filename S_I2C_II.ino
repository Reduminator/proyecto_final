...
#define SL_ADDR 3   // Definimos la dirección del esvlavo

#define Ans_size 19  // Definimos el tamaño esperado de la respuesta del esclavo 

String answer = "Que tal?, Que paso?"; // Creamos una variable String para la respuesta
